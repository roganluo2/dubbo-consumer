...
public class MutexDemo2 {
    ...
    public static void main(String[] args) throws IOException {
        CuratorFramework client = new MutexDemo2().getCuratorFramework();
        SelectorClient2 sc = new SelectorClient2(client, "/leader", "ClientC");
        sc.start();
    ...
    void mutex() throws IOException {
        CuratorFramework curatorFramework = new MutexDemo2().getCuratorFramework();
